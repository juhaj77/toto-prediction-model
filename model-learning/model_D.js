        ...
        fs.createReadStream(tiedostopolku)
            ...
            .on('end', async () => {
                ...
                rawRows.forEach(r => {
                    ...
                    if (!joLisatty) lahtoRyhmat[lahtoAvain].push(r);
                });

                // 2. Ranking-mapit
                const peliRankingMap = {};
                const voittoRankingMap = {};
                ...
                Object.values(lahtoRyhmat).forEach(hevosetLahdossa => {
                    ...
                    const jarjestysPeli   = [...peliAidot].sort((a,b) => (parseFloat(b.Peli_pros)||0) - (parseFloat(a.Peli_pros)||0));
                    const jarjestysVoitto = [...voittoAidot].sort((a,b) => (parseFloat(b.Voitto_pros)||0) - (parseFloat(a.Voitto_pros)||0));
                    ...
                    hevosetLahdossa.forEach(h => {
                        ...
                        rankingDataMap[avain] = { peliKnown: hPeliKnown, voittoKnown: hVoittoKnown };
                    });
                });
